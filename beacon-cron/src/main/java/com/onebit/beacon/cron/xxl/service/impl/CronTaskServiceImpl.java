package com.onebit.beacon.cron.xxl.service.impl;
...
public class CronTaskServiceImpl implements CronTaskService {
    ...
    public BasicResultVO saveCronTask(XxlJobInfo xxlJobInfo) {
        Map<String, Object> params = JSON.parseObject(JSONObject.toJSONString(xxlJobInfo), Map.class);
        String path = xxlJobInfo.getId() == null ? xxlAddresses + XxlJobConstant.INSERT_URL : xxlAddresses + XxlJobConstant.UPDATE_URL;

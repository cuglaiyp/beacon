...
import com.onebit.beacon.common.domain.LogParam;
import com.onebit.beacon.common.enums.AnchorState;
import com.onebit.beacon.handler.pending.Task;
import com.onebit.beacon.handler.pending.TaskPendingHolder;
...
public class Receiver {
     ...
     * @param topicGroupId
     */
    @KafkaListener(topics = "#{'${beacon.business.topic.name}'}")

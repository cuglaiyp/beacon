...
(
    ...
    `audit_status`       tinyint(4)                              NOT NULL DEFAULT '0' COMMENT '当前审核状态： 10.待审核 20.审核成功 30.被拒绝',
    `flow_id`            varchar(50) COLLATE utf8mb4_unicode_ci  NOT NULL DEFAULT '' COMMENT '工单ID',
    `message_status`     tinyint(4)                              NOT NULL DEFAULT '0' COMMENT '当前消息状态：10.新建 20.停用 30.启用 40.等待发送 50.发送中 60.发送成功 70.发送失败',
    ...
    `message_type`       tinyint(4)                              NOT NULL DEFAULT '0' COMMENT '10.通知类消息 20.营销类消息 30.验证码类消息',
    `expect_push_time`   varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '期望发送时间：立即发送.10 定时任务以及周期任务.cron表达式',
    `message_content`    varchar(600) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '消息内容 占位符用{$var}表示',
...
(
    ...
    `message_content`     varchar(600) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '短信发送的内容',
